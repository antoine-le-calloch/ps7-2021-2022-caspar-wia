<template>
  ...
  <div>
    ...
    <input @keypress="numbersOnly($event)" v-model="passport2FirstNumbers" maxlength="2" placeholder="00" id="passport2FirstNumbers" name="passport2FirstNumbers" size="1">
    <input @keypress="lettersOnly($event)" v-model="passport2letters" maxlength="2" placeholder="XX" id="passport2letters" name="passport2letters" size="1">
    <input @keypress="numbersOnly($event)" v-model="passport5LastNumbers" maxlength="5" placeholder="00000" id="passport5LastNumbers" name="passport5LastNumbers" size="4">
    <button type="button" @click="generatePassportId()">Scanner un passeport</button>
    <div class="error" v-if="!isPassportNumberValid">
      Numero de passeport invalide. Réessayer
    </div>
    <div v-else><br></div>
  </div>
...
export default class ConsultFBCAByPassportNumber extends Vue {
  ...
  isPassportNumberValid: boolean = true;
